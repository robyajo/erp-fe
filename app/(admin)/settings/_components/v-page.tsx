...
const settingsLinks = [
  ...
  },
  {
    ...
    label: "Custom Fields",
    icon: Database,
    desc: "Create custom data fields",
  },
  {
    href: "/settings/manage-activity",
    label: "Activity",
    icon: Activity,
    desc: "Activity and email settings",
  },
]

export default function ViewPageSettings() {
  return (
    <PageContainerAdmin
      title="Settings"
      breadcrumb={[
